...
```{r echo = FALSE}
blogdown::shortcode('banner', h='60', title='EDUCACIÓN TEMPRANA', subtitle='Aprendizajes para toda la vida', image='images/post_educacion.png', color='white', bg = '#004e70', .content='El gran esfuerzo que debe hacer el Estado para incentivarla educación es crear unas buenas condiciones de infraestructura, recursos
...
data <- read_csv('../../static/data/gasto_publico.csv') %>% arrange(País)
