...
draft: true
summary: "Desde que se ordeña la vaca, hasta que llega a tu mesa, te contamos todo lo que quieres saber sobre la producción de leche en Colombia."
---
```{r include=FALSE}
library(tidyverse)
library(hgchmagic)
...
La leche es un alimento básico de la canasta familiar del mundo entero, rico en proteínas y grasas que hace parte de la dieta de más de (6 mil millones de personas)[http://www.fao.org/dairy-production-products/products/es/] en el mundo, además de ser considerada el producto más consumido en todos los países en desarrollo.
...
hgch_bar_CatNum(d1, opts = list(colors = theme$colors))
```
...
**Área apilada de producción y acopio de leche por años**
...
**Mapa coropleta regiones por acopio en Colombia**
...
**Gráfica líneas variación precio pagado por litro al productor**
...
**Mapa de conexión de punto de salida a punto de llegada (Top 10)**
...
**Gráfica importaciones y exportaciones**
